...
<div class="container">
    ...
    <hr>
    <br>
    <form method="post" action="functions/edit_banner.php" enctype="multipart/form-data">
        <div class="row">
            <div class="col-md-4">
                <?php if (!empty($image)): ?>
            ...
            <div class="col-md-8">
                <h2 class="mb-4"><?= empty($id) ? 'Create new' : "Edit: $title" ?></h2>
                ...
                <div class="mb-4 form-group">
                    ...
                    <input id="id_title" type="text" placeholder="My title" name="title" class="form-control"
                           value="<?= $title ?>">
                </div>

                <div class="mb-4 form-group">
                    <label for="id_subtitle">Subtitle</label>
                    <input id="id_subtitle" type="text" placeholder="My subtitle" name="subtitle" class="form-control"
                           value="<?= $subtitle ?>">
                </div>
